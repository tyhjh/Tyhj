...
public class MyEssay extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dp = new EssayAdapter(MyEssay.this, R.layout.list_item, essayList);
		init();
		list1.setAdapter(dp);
	}
	private void init() {
		WindowManager wm = (WindowManager) MyEssay.this
	...
	int xxx=(int) (height/25.7);
		...
		back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent in=new Intent(MyEssay.this,MainFace.class);
				startActivity(in);
				MyEssay.this.finish();
			}
		});
		publish.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent in=new Intent(MyEssay.this,Publish.class);
				startActivity(in);
				MyEssay.this.finish();
			}
		});
		...
		Picasso.with(MyEssay.this).load(R.drawable.leftgo).resize(xxxx, xxxx)
		...
		swiperefresh.setOnRefreshListener(new OnRefreshListener() {
			...
			public void onRefresh() {
				...
				new Handler().postDelayed(new Runnable() {
					@Override
					public void run() {
						Intent in = new Intent(MyEssay.this,MyEssay.class);
						MyEssay.this.finish();
						startActivity(in);
						MyEssay.this.overridePendingTransition(R.anim.out, R.anim.enter);  
						// 刷新完成
